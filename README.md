> ! Внимание \ 
> Данный материал расчитан на людей знающих основы языка **Python**
...
# Основы Pydantic: кратко и понятно
...
# Основы SQLAlchemy: кратко и понятно
...
# Конвертация из SQLAlchemy в Pydantic: кратко и понятно
